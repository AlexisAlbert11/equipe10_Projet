...
dist_matrix2 = [
[0, 17, 11, 14, 17, 19, 13, 5, 21, 25, 15, 10, 24, 22, 17, 23, 8, 19, 1, 7],
[17, 0, 10, 5, 21, 16, 4, 20, 21, 25, 11, 16, 11, 11, 21, 23, 15, 9, 21, 1],
[11, 10, 0, 23, 24, 4, 25, 1, 25, 4, 7, 11, 7, 2, 15, 7, 3, 17, 17, 18],
[14, 5, 23, 0, 10, 3, 20, 7, 14, 14, 7, 8, 8, 5, 4, 15, 3, 24, 15, 11],
[17, 21, 24, 10, 0, 5, 19, 8, 6, 22, 5, 20, 21, 12, 3, 18, 11, 1, 20, 21],
[19, 16, 4, 3, 5, 0, 10, 6, 12, 10, 21, 7, 9, 15, 22, 2, 25, 1, 18, 25],
[13, 4, 25, 20, 19, 10, 0, 25, 16, 1, 13, 18, 21, 14, 16, 20, 17, 8, 16, 14],
[5, 20, 1, 7, 8, 6, 25, 0, 11, 12, 12, 5, 14, 3, 16, 25, 6, 15, 12, 1],
[21, 21, 25, 14, 6, 12, 16, 11, 0, 22, 25, 3, 18, 1, 16, 23, 9, 21, 22, 19],
[25, 25, 4, 14, 22, 10, 1, 12, 22, 0, 1, 23, 21, 6, 9, 1, 3, 13, 21, 20],
[15, 11, 7, 7, 5, 21, 13, 12, 25, 1, 0, 25, 21, 8, 22, 21, 19, 19, 4, 17],
[10, 16, 11, 8, 20, 7, 18, 5, 3, 23, 25, 0, 18, 5, 25, 4, 12, 12, 22, 3],
[24, 11, 7, 8, 21, 9, 21, 14, 18, 21, 21, 18, 0, 11, 6, 13, 10, 19, 22, 12],
[22, 11, 2, 5, 12, 15, 14, 3, 1, 6, 8, 5, 11, 0, 15, 11, 6, 4, 24, 12],
[17, 21, 15, 4, 3, 22, 16, 16, 16, 9, 22, 25, 6, 15, 0, 6, 18, 24, 13, 18],
[23, 23, 7, 15, 18, 2, 20, 25, 23, 1, 21, 4, 13, 11, 6, 0, 9, 18, 12, 11],
[8, 15, 3, 3, 11, 25, 17, 6, 9, 3, 19, 12, 10, 6, 18, 9, 0, 7, 1, 19],
[19, 9, 17, 24, 1, 1, 8, 15, 21, 13, 19, 12, 19, 4, 24, 18, 7, 0, 5, 15],
[1, 21, 17, 15, 20, 18, 16, 12, 22, 21, 4, 22, 22, 24, 13, 12, 1, 5, 0, 1],
[7, 1, 18, 11, 21, 25, 14, 1, 19, 20, 17, 3, 12, 12, 18, 11, 19, 15, 1, 0]
]

# Matrice pour Coor_inst3
dist_matrix3 = [
    [0.0, 5.22, 1.8, 2.37, 7.3, 7.72, 5.11, 4.99, 7.91, 6.99],
    [5.22, 0.0, 7.02, 4.29, 3.47, 9.28, 8.02, 3.06, 10.2, 3.93],
    [1.8, 7.02, 0.0, 3.98, 11.28, 7.76, 6.32, 5.55, 7.95, 7.86],
    [2.37, 4.29, 3.98, 0.0, 6.59, 11.83, 3.82, 6.96, 10.76, 6.83],
    [7.3, 3.47, 11.28, 6.59, 0.0, 11.49, 7.65, 6.08, 11.67, 2.3],
    [7.72, 9.28, 7.76, 11.83, 11.49, 0.0, 18.62, 16.57, 9.16, 15.75],
    [5.11, 8.02, 6.32, 3.82, 7.65, 18.62, 0.0, 12.63, 13.48, 5.71],
    [4.99, 3.06, 5.55, 6.96, 6.08, 16.57, 12.63, 0.0, 9.73, 8.83],
    [7.91, 10.2, 7.95, 10.76, 11.67, 9.16, 13.48, 9.73, 0.0, 11.1],
    [6.99, 3.93, 7.86, 6.83, 2.3, 15.75, 5.71, 8.83, 11.1, 0.0]
    ]
...
Lieux2 = ["Entreprise", "École", "Lieu1", "Lieu2", "Lieu3", "Lieu4", "Lieu5", "Lieu6", "Lieu7", "Lieu8", "Lieu9", "Lieu10", "Lieu11", "Lieu12", "Lieu13", "Lieu14", "Lieu15", "Lieu16", "Lieu17", "Lieu18"]
Lieux3 = ["Entreprise", "École", "Lieu1", "Lieu2", "Lieu3", "Lieu4", "Lieu5", "Lieu6", "Lieu7", "Lieu8"]

Lieux = [Lieux1, Lieux2, Lieux3]

# Définir le nombre d'étudiants pour chaque instance (convertir les chaînes en entiers)
nb_etudiant1 =  [0, 0, 2, 18, 7, 19, 19, 20, 8, 19, 7, 2, 7, 16, 13, 16, 19, 2, 8, 15, 20, 11, 17, 3, 13, 16, 19, 18, 7]
nb_etudiant2 = [0, 0, 1, 10, 8, 20, 6, 3, 6, 12, 15, 4, 17, 1, 15, 8, 13, 10, 12, 7]
nb_etudiant3 = [0, 0, 9, 15, 13, 9, 19, 12, 15, 14]
...
###                           AMPL                            ###
    ...
    # Résoltion des 3 instances par frp_ampl_mip_solver #

# for i in range(2):
#     dist_matrix = dist_matrixes[i]  
#     Autobus = buses[i]  
#     nb_etudiant = nb_etudiant[i]  
#     vitesse_moyenne = vitesses_moyennes[i]  
#     Lieux = Lieux[i]  

#     problem = frp.FastRouteProb(dist_matrix)

#     eleves = [élève.Élève(nb) for nb in nb_etudiant[i]]

#     solver = frp_solver.FrpAmplMipSolver()
#     solution_routes = solver.solve(problem, Autobus, eleves, vitesse_moyenne)

#     rsol.Route.evaluate(solution_routes)

dist_matrix = dist_matrixes[0]  
Autobus = buses[0]  
nb_etudiant = nb_etudiant[0]  
vitesse_moyenne = vitesses_moyennes[0]  
Lieux = Lieux[0]  
#=== Initialisation du problème ===
problem = frp.FastRouteProb(dist_matrix)

# === Création des objets Élève ===
eleves = [élève.Élève(nb) for nb in nb_etudiant]

# === Initialisation et exécution du solveur ===
solver = frp_solver.FrpAmplMipSolver()
solution_routes = solver.solve(problem, Autobus, eleves, vitesse_moyenne)
